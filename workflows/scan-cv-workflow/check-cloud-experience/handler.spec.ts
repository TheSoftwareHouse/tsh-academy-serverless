import { checkCloudExperience } from "./handler";
...
describe("check cloud experience", () => {
  it("should return cloud experience", async () => {
    ...
    const result = await checkCloudExperience(event, config, s3Mock);
