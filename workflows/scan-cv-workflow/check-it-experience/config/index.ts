...
export interface CheckITExperienceLambdaEnvironmentVariables {
...
const validateConfig = (config: ReturnType<typeof loadEnvs>): CheckITExperienceLambdaEnvironmentVariables => {
